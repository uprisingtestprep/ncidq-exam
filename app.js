/* NCIDQ Exam Simulator — Application Logic */

const ACCESS_CODE  = "NCIDQ9000";
const EXAM_SECONDS = 36000;
const PASSING_PCT  = 75;
const STORAGE_KEY  = "ncidq_exam_state_v1";
const SIM_Q_COUNT  = 315;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const DOMAIN_LABELS = {"existing_conditions": "Existing Conditions", "pre_design": "Pre-Design", "programming": "Programming", "space_planning": "Space Planning", "preliminary_ff_e_and_finishes": "Preliminary FF&E and Finishes", "schematics": "Schematics", "feasibility_studies": "Feasibility Studies", "scheduling_and_budgeting": "Scheduling and Budgeting", "contracts_procurement_and_permitting": "Contracts Procurement and Permitting", "construction_process": "Construction Process", "site_observation_and_close_out": "Site Observation and Close-Out", "codes_and_life_safety": "Codes and Life Safety", "integration_and_ff_e": "Integration and FF&E", "construction_documents": "Construction Documents", "consultant_drawing_coordination": "Consultant Drawing Coordination", "construction_specifications_and_schedules": "Construction Specifications and Schedules"};  // maps domain key -> human-readable label for display
